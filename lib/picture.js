...
async function init() {
  ...
  $(".result")[0].innerHTML = `<div class="question__title"><mark>${name}님은<br> ${Math.max(...mbtiPercent)}로<br> ${mbtiCompare[mbtiPercent.indexOf(Math.max(...mbtiPercent))].name}입니다</mark></div>
  <div class="picture__container" style="margin-top: 450px">
    <a class="picture__button" type="button" onclick="location.reload()">다시하기</a>
  </div>`;
