...
async function init() {
  ...
  $(".result__title")[0].innerHTML = `<mark>${name}님은<br>${mbtiCompare[mbtiPercent.indexOf(Math.max(...mbtiPercent))].name}입니다</mark>`;
  $(".process")[0].style.display = "none";
  $(".result")[0].style.display = "block";
  $(".logo")[0].style.position = "static";
  $(".logo")[0].style.marginTop = "100px";
